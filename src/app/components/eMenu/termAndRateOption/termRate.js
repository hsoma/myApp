  ...
  render() {
    ...
    return (
      <div className="row">
        ...
        <button style={this.props.hideRatesButton ? {display:'none'} : {}} className="btn btn-primary pull-right btn-cus" type="button" id="GetRatesButton" onClick={() => { this.refs['grid'].wrappedInstance.submitHandle(); }}>get rates</button>
      </div>
    );
  }
